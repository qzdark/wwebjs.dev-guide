<template>
	<router-link :to="$localePath" class="guide-logo">
		<img class="site-name" alt="Banner">
	</router-link>
</template>

<style lang="stylus">
.guide-logo .site-name {
	image: url('/branding/dark/banner_green_logo.png') top left / contain no-repeat;
	padding-left: 1.5em;
	max-height: 100%;
	display: flex;
	align-items: center;
...
.yuu-theme-red {
	.guide-logo .site-name {
		background-image: url('/branding/dark/banner_red_logo.png');
	}
}
.yuu-theme-blue {
	.guide-logo .site-name {
		background-image: url('/branding/dark/banner_blue_logo.png');
	}
}
.yuu-theme-purple {
	.guide-logo .site-name {
		background-image: url('/branding/dark/banner_purple_logo.png');
	}
}
